  ...
  return (
    <nav className="flex flex-col absolute z-50 w-full items-center">
      <div className="w-[100%] max-w-[1440px] flex flex-row justify-between m-auto 2xl:px-0 px-[30px] sm:px-[50px] p-6">
        ...
        {/* Mobile menu start */}
        <div
          className={` bg-black text-white fixed z-[100] flex flex-col lg:hidden left-0 top-0 w-[60%] h-full  ease-in-out duration-500 ${
            nav ? "" : "left-[-100%]"
          }`}
        >
          ...
          <div className="block md:hidden">
            <li className="flex my-3 justify-center items-center">
              <Link href="/contact" onClick={toggleNav}>
                <div className="flex cursor-pointer flex-row justify-start items-center ease-in duration-300  b-[1px] font-medium text-[15px] border rounded-md font-lexend">
        ...
        <>
          ...
          <div className="hidden md:flex flex-row z-50 pt-2 font-Inter">
            <Link href="/contact" onClick={toggleNav}>
              <div className="group flex cursor-pointer flex-row justify-center items-center ease-in duration-300 b-[1px] font-medium lg:text-[13px] xl:text-[15px] 2xl:text-[18px] border rounded-md border-primary px-2 2xl:w-[210px] xl:h-[48px] h-[56px] 2xl:h-[56px] hover:bg-primary font-lexend">
                <span className="mx-4">Contact Us</span>
                <GoArrowUpRight className="icon lg:text-[13px] xl:text-[16px] 2xl:group-hover:text-[17px]" />
              </div>
            </Link>
